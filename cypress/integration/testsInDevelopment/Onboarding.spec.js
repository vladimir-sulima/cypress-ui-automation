...
const existingUserEmail = "mypay.vladimir+20813101959@gmail.com";
...
var mainFlowData = {
  ...
  password: existingUserEmail,
  confirmPassword: existingUserEmail,
  ...
  onboardingData: {
    ...
    step8_uploadDocuments: {
      filesToUpload: ["jpg_sample.jpg", "png_sample.png", "pdg_sample.pdf", "jpeg_sample.jpeg"]
    }
  },
};
//#endregion
...
describe("Onboarding", function () {
  it("Log in", function () {
    ...
    it("Create merchant", function () {
      ...
      merchant_ManipulationScenarios.verify_NewMerchantCreatedSuccessfully(mainFlowData.merchants.merchant_1);
  ...
  it("Verify input fields for Onboarding step 5 - business profile page", function () {
    onboarding_scenarios.verify_Step_5_business_profile_pageDisplayed();
    onboarding_scenarios.verify_NextButton_Status(false);
  })
  ...
  it("Verify input fields for Onboarding step 7 - Product required page", function () {
    onboarding_scenarios.verify_step_7_product_required_pageDisplayed()
    onboarding_scenarios.verify_NextButton_Status(false);
  })
  it("Set data for Onboarding step 7 - Product required page", function () {
  ...
  //STEP 8
  it("Verify UI element on Onboarding step 8 - Document Check page", function () {
    onboarding_scenarios.verify_Step_8_UploadDocuments_UIElement_Displayed();
    onboarding_scenarios.verify_NextButton_Status(false);
  });
  it("Upload files", function () {
    onboarding_scenarios.uploadFiles_Step_8_UploadDocuments_Form(mainFlowData.onboardingData);
    onboarding_scenarios.verify_Step_8_UploadDocuments_ListOfUploadedFiles_Displayed(mainFlowData.onboardingData);
    onboarding_scenarios.verify_NextButton_Status(true);
    onboarding_scenarios.proceedToTheNextStep();
  });
